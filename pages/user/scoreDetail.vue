<template>
	<view class="wrap">
		...
		<view class="score-wrap">
			<view class="left">
				<view class="title" v-if="accountType==1">积分（Love Bird）:</view>
				<view class="title" v-if="accountType==3">币账户:</view>
				<div class="number">{{account?account.toFixed(2):"0.00"}}</div>
			</view>
			<view class="left active" v-if="accountType==3">
	...
	export default {
		data() {
			return {
				...
				accountType:"",//账户类型;1:Love Bird积分, 2:LB积分, 3:Love Bird， 4:LB,
				detailList:[],
				start:false,
				index:null,
