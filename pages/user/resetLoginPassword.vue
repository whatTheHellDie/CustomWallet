<template>
	<view class="content wrap">
		...
		<view class="row b-b" v-else>
			<text class="tit">BT账号:</text>
			<input type="text" class="input" placeholder="请输入账号" v-model="userNumber" />
			<!-- <input class="input" type="text" v-model="userPassword.name" placeholder="账号" placeholder-class="placeholder" /> -->
		</view>
...
.forget-password{color: #7101da;font-size: 28rpx;margin-top: 24rpx;}
	.row{
		display: flex;
		align-items: center;
		position: relative;
	...
	.add-btn{
		...
		font-size: $font-lg;
		color: #fff;
		background:linear-gradient(90deg,rgba(103,31,249,1) 0%,rgba(170,98,252,1) 53%,rgba(230,158,255,1) 100%);
		border-radius: 50rpx;
	}
	.change-address{
		width: 100%;
