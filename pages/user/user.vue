	...
	<view>
		<view class="fixed-top  wrap-tab">
			...
			<view class="user-info" :class="{'notLogin':hasLogin}" @tap="toUser">
				<image @tap="uploadPortrait" :src="portrait" class="face"
				 mode=""></image>
		...
		<view class="my-content">
			...
			<view class="context-shadow" v-if="showShadow" @tap="showShadow=false"></view>
...
<script>
	...
	export default {
		data() {
			return {
				picList:["/static/a1.png","/static/a2.png","/static/a3.png","/static/a4.png","/static/a5.png","/static/a6.png","/static/a7.png","/static/a8.png","/static/a9.png"],
				isVip: false,
				message: "",
				showShadow: false,
				portrait:''
		...
		onLoad(option) {
			...
			this.portrait=this.userInfo.portrait?this.userInfo.portrait:'/static/missing-face.jpg'
		},
		onShow() {
			this.getUserInfo();
			this.isNodeVip()
					...
					uni.request({
						...
						success: (res) => {
							if (res.data.code === 0) {
								...
								this.portrait=res.data.data.portrait?res.data.data.portrait:'/static/missing-face.jpg'
							} else {
