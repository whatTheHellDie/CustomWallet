<template>
	<view class="content wrap">
		...
		<view class="row b-b">
			...
			<input type="text" class="input" placeholder="请输入账号" v-model="loginUserInfo.userNumber" />
			...
			<view class="show-record" @tap="showShadow=false" v-if="showShadow">
...
<style lang="scss">
	...
	.show-record{position: absolute;top: 80rpx;background: #fff;z-index: 11;width: 500rpx;
	.li{
