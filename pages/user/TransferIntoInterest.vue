<template>
	<view class="wrap-content wrap">
		...
		<view class="row b-b into-interest">
			...
			<input class="interest-input" type="text" v-model="scoreNumber" placeholder="请输入需要定存的Love Bird积分数额" placeholder-class="placeholder" />
			<view class="balance">Love Bird积分数额: {{balance}}</view>
		</view>
		<view class="row b-b">
