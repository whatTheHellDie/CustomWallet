<template>
	<view class="content wrap">
		...
		<view class="row b-b">
			...
			<input class="input" type="text" v-model="registerData.referrerNumber" placeholder="请输入邀请码" placeholder-class="placeholder" />
		</view>
		<view class="row b-b">
		...
		<view class="read-agree"><checkbox class="checkbox" value="cb" @tap="choose=!choose" :checked="choose" color="#671ff9" style="transform:scale(0.7)" />阅读并同意<text class="text" @tap="toPro">《用户注册协议》</text></view>
...
<style lang="scss">
	...
	.add-btn{
		...
		font-size: $font-lg;
		color: #fff;
		background:linear-gradient(90deg, #af01dc 0%, #3802d9 100%);
		border-radius: 50rpx;
	}
	.change-address{
		width: 100%;
	...
	top: 28rpx;
	right: 32rpx;}
	.msg{color: #671ff9;font-size: 32rpx;}
	.zone-picker{
		position: relative;
