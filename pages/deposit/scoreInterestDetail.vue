<template>
	...
	<view class="my-score">
		...
		<view>
			<view class="deposit-text">定存积分利息（Love Bird）</view>
			<view class="number">{{balance}}</view>
			<view class="end-time"><image class="end-img" src="/static/ic_mark@2x.png" mode=""></image>未到期转出，则利息按活期Love Bird积分日利率计算！</view>
		</view>
	</view>
