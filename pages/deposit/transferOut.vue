<template>
	<view class="wrap-content wrap">
		...
		<view>
			<view class="info-tip"><image class="mark-img" src="/static/ic_mark2@2x.png" mode=""></image>未到期转出，则利息按活期Love Bird积分日利率计算！</view>
...
<style lang="scss">
	...
	.info-tip{
		min-height:80rpx;
		color: #7101DA;
		background:rgba(113,1,218,.1);font-size: 26rpx;display: flex;align-items: center;
