    ...
    <view class="comfirm-list my-order-list">
      <view class="ul">
      	<view class="li">
      	  ...
      	  <view class="way">支付方式 <text class="right-span">Love Bird币</text>
		  </view>
      	  <view class="way">实际支付<text class="right-type color"><img src="" alt="" class="coin" />{{item.totalPrice?item.totalPrice.toFixed(2):"0.00"}}Love Bird币</text></view>
      	</view>
      </view>
      <view class="way-top">
			...
			uni.request({
				...
				success: (res) => {
					if (res.data.code === 0) {
						...
						item.currencyImg='/static/ic_coin_big.png';
