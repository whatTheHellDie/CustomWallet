<template>
  <view class="wrap wrap-tab" :class="{'yellow-theme':isYellow}">
      <view class="navbar" ><!--白色背景还是灰色背景-->
	  <view class="input-wrap">
		  <input type="text" v-model="keyword" placeholder="请输入搜索内容" class="input">
		  <image src="/static/ic_search@2x.png" class="search"  @tap="toSearchNews" mode=""></image>
		  </view>
